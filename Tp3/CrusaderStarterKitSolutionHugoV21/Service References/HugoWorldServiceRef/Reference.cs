...
namespace HugoWorldServiceRef {
    ...
    public interface IHeroController {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHeroController/CheckIfHeroesAt", ReplyAction="http://tempuri.org/IHeroController/CheckIfHeroesAtResponse")]
        bool CheckIfHeroesAt(int heroId, int x, int y, string area);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHeroController/CheckIfHeroesAt", ReplyAction="http://tempuri.org/IHeroController/CheckIfHeroesAtResponse")]
        System.Threading.Tasks.Task<bool> CheckIfHeroesAtAsync(int heroId, int x, int y, string area);
    ...
    public partial class HeroControllerClient : System.ServiceModel.ClientBase<HugoWorldServiceRef.IHeroController>, HugoWorldServiceRef.IHeroController {
        ...
        public bool CheckIfHeroesAt(int heroId, int x, int y, string area) {
            return base.Channel.CheckIfHeroesAt(heroId, x, y, area);
        }
        
        public System.Threading.Tasks.Task<bool> CheckIfHeroesAtAsync(int heroId, int x, int y, string area) {
            return base.Channel.CheckIfHeroesAtAsync(heroId, x, y, area);
        }
        
        public string AttackHeroAt(int attackerHeroId, int x, int y, string area) {
            return base.Channel.AttackHeroAt(attackerHeroId, x, y, area);
        }
        
        public System.Threading.Tasks.Task<string> AttackHeroAtAsync(int attackerHeroId, int x, int y, string area) {
    ...
    public interface IMonstreController {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMonstreController/KillMonster", ReplyAction="http://tempuri.org/IMonstreController/KillMonsterResponse")]
        void KillMonster(int mondeId, int x, int y);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMonstreController/KillMonster", ReplyAction="http://tempuri.org/IMonstreController/KillMonsterResponse")]
        System.Threading.Tasks.Task KillMonsterAsync(int mondeId, int x, int y);
    }
    ...
    public partial class MonstreControllerClient : System.ServiceModel.ClientBase<HugoWorldServiceRef.IMonstreController>, HugoWorldServiceRef.IMonstreController {
        ...
        public void KillMonster(int mondeId, int x, int y) {
            base.Channel.KillMonster(mondeId, x, y);
        }
        
        public System.Threading.Tasks.Task KillMonsterAsync(int mondeId, int x, int y) {
            return base.Channel.KillMonsterAsync(mondeId, x, y);
        }
    }
